...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['RowCount']=1
        fig = px.pie(filtered_df, values='RowCount', 
        names='class', 
...
def success_payload_scatter_chart(entered_site,payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(
            data_frame=filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
